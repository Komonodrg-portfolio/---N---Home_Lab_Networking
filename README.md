...
| Step    | Command |
|---------|---------|
| 1) Navigate to EVE-NG Download page and download both: <br> a) EVE-NG CE.iso<br> b) Client Side Toools (Windows/Linux)  | <img src="images/EVENGVM1.png" alt="Image 1" width="45%" style="margin-Center: 10px;"/><img src="images/EVENGVM2.png" alt="Image 1" width="45%" style="margin-Center: 10px;"/> |
